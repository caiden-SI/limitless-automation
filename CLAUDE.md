...
- ClickUp status names are lowercase: idea, ready for shooting, ready for editing, in editing, uploaded to dropbox, sent to client, posted by client, done, waiting
