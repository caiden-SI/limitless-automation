...
export const AGENT_REGISTRY = {
  ...
  'footage-scan': {
    ...
    // ~5 rows/day per the May 4 census. Thresholds calibrated for
    // genuine degradation, not normal idleness: a quiet day with no
    // Dropbox activity is healthy, not amber.
    greenWithinMs: 24 * HOUR,
    redAfterMs: 48 * HOUR,
    description:
  ...
  scripting: {
    ...
    // Thresholds calibrated for genuine degradation, not normal
    // idleness: a stretch with no upcoming filming events is
    // healthy, not amber.
    greenWithinMs: 6 * HOUR,
    redAfterMs: 24 * HOUR,
    description:
